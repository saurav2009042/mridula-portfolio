...
export const teamMembers = [
    { name: 'Madhurima Ghosh', role: 'PH.D Student', period: 'August 2025 - Present', img: MadhurimaImg },
    { name: 'Arslan Mumtaz', role: 'Ph.D Student', period: 'April 2023 - Present', img: ArslanImg },
    { name: 'Aneet Kumar Dutta', role: 'Ph.D Student', period: 'June 2022 - Present', img: AneetImg },
    { name: 'Usaid Bhirya', role: 'HiWi', period: 'April 2025 - Present', img: UsaidImg },
    { name: 'Hossam Eldin Faramawy', role: 'HiWi', period: 'December 2024 - Present', img: HossamImg },
    { name: 'Jishitha Kondaveti', role: 'HiWi', period: 'August 2024 - Present', img: JishithaImg },
];
